...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-option", "--option", required=True, help="batting or bowling", type=str
    )
    parser.add_argument(
        "-hand", "--hand", required=True, help="left or right", type=str
    )
    parser.add_argument(
        "-view", "--view", required=True, help="Front or side", type=str
    )
