...
class RightHandedBatting(Batting):
    def __init__(self):
        ...
        # self.threaded_camera_front = ThreadedCamera(0)
        # self.cap_front = cv2.VideoCapture(0)
        # self.threaded_camera_side = ThreadedCamera(0)
        ...
        with self.mp_holistic.Holistic(
            ...
            while True:
                ...
                try:
                    ...
                    l1 = np.linspace(
                        idx_to_coordinates[23], idx_to_coordinates[25], 100
                    )
                    l2 = np.linspace(
                        idx_to_coordinates[25], idx_to_coordinates[27], 100
                    )
                    cv2.line(
                        image,
                        (int(l1[99][0]), int(l1[99][1])),
                        (int(l1[59][0]), int(l1[59][1])),
                        thickness=3,
                        color=(0, 0, 255),
                    )
                    cv2.line(
                    ...
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[25][0] + 20, idx_to_coordinates[25][1]),
                ...
                try:
                    ...
                    l1 = np.linspace(
                        idx_to_coordinates[15], idx_to_coordinates[13], 100
                    )
                    l2 = np.linspace(
                        idx_to_coordinates[13], idx_to_coordinates[11], 100
                    )
                    cv2.line(
                        image,
                        (int(l1[99][0]), int(l1[99][1])),
                    ...
                    ang2 = ang(
                        (idx_to_coordinates[15], idx_to_coordinates[13]),
                        (idx_to_coordinates[13], idx_to_coordinates[11]),
                    )
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[13][0] + 10, idx_to_coordinates[13][1]),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.6,
                        color=(0, 255, 0),
                        thickness=2,
                ...
                try:
                    # shoulder back knee
                    l1 = np.linspace(
                        idx_to_coordinates[11], idx_to_coordinates[23], 100
                    )
                    l2 = np.linspace(
                        idx_to_coordinates[23], idx_to_coordinates[25], 100
                    )
                    ...
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[23][0] + 20, idx_to_coordinates[23][1]),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.6,
                        color=(0, 255, 0),
                        thickness=2,
                ...
                try:
                    ...
                    cv2.line(
                        image,
                        (left_foot[0], left_foot[1] + 50),
                        (left_hand[0], left_foot[1] + 50),
                        thickness=2,
                        color=(255, 255, 0),
                    )
                    cv2.line(
                    ...
                    cv2.line(
                        image,
                        (left_hand[0], left_foot[1] + 50),
                        (left_hand[0], left_foot[1] + 60),
                        thickness=2,
                        color=(255, 255, 0),
                    )
                    cv2.putText(
                        image,
                        str(max(0, left_foot[0] - left_hand[0])) + " px",
                ...
                if 0 in idx_to_coordinates:
                    cv2.putText(
                        ...
                        (
                            idx_to_coordinates[0][0] - 120,
                            idx_to_coordinates[0][1] - 100,
                        ),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.9,
                        color=(0, 255, 0),
                ...
                # Tracking the Red coloured ball

                hsv = cv2.cvtColor(image, cv2.COLOR_BGR2HSV)
                kernel = np.ones((5, 5), np.uint8)
                # Lower_red = np.array([150, 50, 50])   # Lower boundary for pink
                # Upper_red = np.array([170, 255, 255]) # Upper boundary for pink
                Lower_red = np.array([0, 100, 100])  # Lower boundary for red
                Upper_red = np.array([10, 255, 255])  # Upper boundary for red
                # Lower_red = np.array([10, 50, 50])  # Lower boundary for brown
                # Upper_red = np.array([20, 255, 255])  # Upper boundary for brown
                ...
                # Lower_green = np.array([29, 86, 6])
                # # Lower_green = np.array([40, 10, 230])
                # # Upper_green = np.array([64, 255, 255])
                # Upper_green = np.array([40, 10, 235])
            ...
            while True:
                ...
                try:
                    ...
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[25][0] + 10, idx_to_coordinates[25][1]),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.6,
                        color=(0, 255, 0),
                        thickness=2,
                ...
                try:
                    ...
                    l1 = np.linspace(
                        idx_to_coordinates[24], idx_to_coordinates[26], 100
                    )
                    l2 = np.linspace(
                        idx_to_coordinates[26], idx_to_coordinates[28], 100
                    )
                    cv2.line(
                        image,
                        (int(l1[99][0]), int(l1[99][1])),
                    ...
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[26][0] + 20, idx_to_coordinates[26][1]),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.6,
                        color=(0, 255, 0),
                        thickness=2,
                ...
                try:
                    ...
                    cv2.putText(
                        image,
                        str(round(ang2, 2)),
                        (idx_to_coordinates[23][0] + 10, idx_to_coordinates[23][1]),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                        fontScale=0.6,
                        color=(0, 255, 0),
                        thickness=2,
                ...
                try:
                    ...
                    cv2.line(
                        image,
                        (right_foot[0], right_foot[1] + 50),
                        (left_foot[0], right_foot[1] + 50),
                        thickness=2,
                        color=(255, 51, 51),
                    )
                    cv2.line(
                    ...
                    cv2.line(
                        image,
                        (left_foot[0], right_foot[1] + 50),
                        (left_foot[0], right_foot[1] + 60),
                        thickness=2,
                        color=(255, 51, 51),
                    )
                    cv2.putText(
                        image,
                        str(max(0, right_foot[0] - left_foot[0])) + " px",
