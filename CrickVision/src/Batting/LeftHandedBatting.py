    ...
    def front_batting(self):
        ...
        with self.mp_holistic.Holistic(
            ...
            while True:
                ...
                # Will only look at right side for left handed batsman
                try:
                    ...
                    cv2.putText(image, str(round(ang2, 2)), (idx_to_coordinates[26][0] + 10, idx_to_coordinates[26][1]),
                ...
                try:
                    ...
                    l1 = np.linspace(idx_to_coordinates[16], idx_to_coordinates[14], 100)
                    l2 = np.linspace(idx_to_coordinates[14], idx_to_coordinates[12], 100)
                    cv2.line(image, (int(l1[99][0]), int(l1[99][1])), (int(l1[59][0]), int(l1[59][1])), thickness=6,
                             color=(0, 0, 255))
                    cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[40][0]), int(l2[40][1])), thickness=6,
                             color=(0, 0, 255))
                    ang2 = ang((idx_to_coordinates[16], idx_to_coordinates[14]),
                               (idx_to_coordinates[14], idx_to_coordinates[12]))
                    cv2.putText(image, str(round(ang2, 2)), (idx_to_coordinates[14][0] + 20, idx_to_coordinates[14][1]),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                                fontScale=0.6, color=(0, 255, 0), thickness=2)
                    center, radius, start_angle, end_angle = convert_arc(l1[90], l2[10], sagitta=15)
                    axes = (radius, radius)
                ...
                try:
                    ...
                    cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[30][0]), int(l2[30][1])), thickness=6,
                             color=(0, 0, 255))
                    ang2 = ang((idx_to_coordinates[12], idx_to_coordinates[24]),
                               (idx_to_coordinates[24], idx_to_coordinates[26]))
                    cv2.putText(image, str(round(ang2, 2)), ((idx_to_coordinates[24][0] + 20, idx_to_coordinates[24][1])),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                                fontScale=0.6, color=(0, 255, 0), thickness=2)
                    center, radius, start_angle, end_angle = convert_arc(l1[90], l2[10], sagitta=15)
                    axes = (radius, radius)
                ...
                try:
                    # Distance between right foot and right hand
                    right_foot = idx_to_coordinates[30]
                    right_hand = idx_to_coordinates[18]
                    cv2.line(image, (right_foot[0], right_foot[1] + 50), (right_hand[0], right_foot[1] + 50),
                             thickness=2,
                             color=(255, 255, 0))
                    cv2.line(image, (right_foot[0], right_foot[1] + 50), (right_foot[0], right_foot[1] + 60),
                             thickness=2,
                             color=(255, 255, 0))
                    cv2.line(image, (right_hand[0], right_foot[1] + 50), (right_hand[0], right_foot[1] + 60),
                             thickness=2,
                             color=(255, 255, 0))
                    cv2.putText(image, str(max(0, right_hand[0] - right_foot[0])) + " px",
                                (right_foot[0] - 50, right_foot[1] + 80),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                ...
                Lower_green = np.array([101, 63, 192])
                #Upper_green = np.array([64, 255, 255])
                Upper_green = np.array([101, 63, 192])
        ...
        with self.mp_holistic.Holistic(
            ...
            while True:
                ...
                try:
                    ...
                    ang2 = ang((idx_to_coordinates[16], idx_to_coordinates[14]),
                               (idx_to_coordinates[14], idx_to_coordinates[12]))
                    cv2.putText(image, str(round(ang2, 2)), (idx_to_coordinates[14][0] + 10, idx_to_coordinates[14][1]),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                                fontScale=0.6, color=(0, 255, 0), thickness=2)
                    center, radius, start_angle, end_angle = convert_arc(l1[90], l2[10], sagitta=15)
                    axes = (radius, radius)
                ...
                try:
                    ...
                    right_foot = idx_to_coordinates[30]
                    right_hand = idx_to_coordinates[18]
                    cv2.line(image, (right_foot[0], right_foot[1] + 50), (right_hand[0], right_foot[1] + 50), thickness=2,
                             color=(255, 255, 0))
                    cv2.line(image, (right_foot[0], right_foot[1] + 50), (right_foot[0], right_foot[1] + 60), thickness=2,
                             color=(255, 255, 0))
                    cv2.line(image, (right_hand[0], right_foot[1] + 50), (right_hand[0], right_foot[1] + 60), thickness=2,
                             color=(255, 255, 0))
                    cv2.putText(image, str(max(0, right_hand[0] - right_foot[0])) + " px",
                                (right_foot[0] + 50, right_foot[1] + 80),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                ...
                if 0 in idx_to_coordinates:
                    cv2.putText(image, "Batsman : Left Handed",
                                (idx_to_coordinates[0][0] - 180, idx_to_coordinates[0][1] - 100),
                                fontFace=cv2.FONT_HERSHEY_SIMPLEX,
                                fontScale=0.9, color=(0, 255, 0), thickness=2)
